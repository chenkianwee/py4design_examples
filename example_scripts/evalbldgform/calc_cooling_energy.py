...
for facade in facade_list:
    ...
    win_occface = py3dmodel.fetch.topo2topotype(py3dmodel.modify.uniform_scale(facade, 0.1,0.1,0.1, fmidpt))
...
for wall in wall_occface_list:
    shp_attribs = buildingformeval.create_opaque_srf_shape_attribute(wall,1,"wall" )
...
floor_area = py3dmodel.calculate.face_area(occface)
