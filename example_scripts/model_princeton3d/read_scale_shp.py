...
shp_file = "F:\\kianwee_work\\princeton\\2019_06_to_2019_12\\campus_as_a_lab\\model3d\\shp\\bldg_tree_facilities\\bldg_other_moved.shp"
#specify the orig reference point
origpt_shp_file = "F:\\kianwee_work\\princeton\\2019_06_to_2019_12\\campus_as_a_lab\\model3d\\shp\\points\\target_pt.shp"
...
filename = "bldg_other_moved_scaled.shp"
#===========================================================================================
#FUNCTION
#===========================================================================================
...
#===========================================================================================
time1 = time.clock()
print "*******Reading the Shp File 2be Scaled***************"
...
print "*******Scaling and Writing the Shp File***************"
scaled_cmpd = py3dmodel.modify.scale(cmpd, 0.304802766923453, orig_pt)
res_filepath = os.path.join(result_directory, filename)

wire_list = py3dmodel.fetch.topo_explorer(scaled_cmpd, "wire")
