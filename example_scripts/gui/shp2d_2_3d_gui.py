...
class Shp2DTo3DGUI(QtGui.QWidget):
    def __init__(self):
        ...
        self.shapefile = dict(name='Shape File', type='group', title = "Specify Shape File",
                              children=[dict(name='Load Shapefile', type='action'), 
        ...
        self.dtmfile = dict(name='DTM File', type='group', title = "Specify DTM File",
                              children=[dict(name='Load DTM', type='action'), 
                                        dict(name='DTM Loaded', type = 'str', value = "", readonly = True)])
    
        self.result_directory = dict(name='Result Directory', type='group', title = "Specify Result Directory",
                              children=[dict(name='Choose Result Directory', type='action'), 
                                        dict(name='Result Directory Chosen', type = 'str', value = "", readonly = True)])
    
        self.interactive_view = dict(name='Interactive View', type='group', expanded = False, title = "Turn off Interactive Viewer",
