...
collada_filepath = "F:\\kianwee_work\\smart\\DeliveryHeightDTM\\extracted_info\\telok_kurau\\collada\\telok_kurau_footprint_35.dae"
txt_filepath = "F:\\kianwee_work\\smart\\DeliveryHeightDTM\\extracted_info\\telok_kurau\\txt\\telok_kurau_footprint_35.txt"
xdim = 35.0
ydim = 35.0
#===========================================================================================
...
shp_in_boundary_cmpd = py3dmodel.construct.make_compound(total_occface_list)
...
#py3dmodel.utility.visualise([grid_face_list[0:35]], ["WHITE"])
...
for grid_face in grid_face_list:
    ...
    grid_footprint_cmpd = py3dmodel.construct.boolean_common(shp_in_boundary_cmpd, grid_extruded)
    is_cmpd_null = py3dmodel.fetch.is_compound_null(grid_footprint_cmpd)
    if not is_cmpd_null:
        grid_footprint_list = py3dmodel.fetch.topo_explorer(grid_footprint_cmpd, "face")
...
for grid_footprint_list in grid_footprint_2dlist:
    ...
    for grid_footprint in grid_footprint_list:
        area = area +  py3dmodel.calculate.face_area(grid_footprint)
...
total_footprint_cmpd = py3dmodel.construct.make_compound(total_grid_footprint_list)
edge_list = py3dmodel.fetch.topo_explorer(total_footprint_cmpd, "edge")
...
print time_spent
#py3dmodel.construct.visualise([grid_face_list,total_grid_facade_list], ["WHITE", "RED"])