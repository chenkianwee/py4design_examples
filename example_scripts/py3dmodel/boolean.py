...
face = py3dmodel.fetch.geom_explorer(res, "face")[0]
print py3dmodel.fetch.geom_explorer(face, "wire")
sensor_surfaces, sensor_pts, sensor_dirs = gml3dmodel.generate_sensor_surfaces(face, 10,10)
...
#colour_list.append("WHITE")
py3dmodel.construct.visualise(display2dlist, colour_list)