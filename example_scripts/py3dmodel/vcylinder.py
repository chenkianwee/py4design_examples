# -*- coding: utf-8 -*-
"""
Created on Thu Oct 26 22:08:07 2017
...
face_scaled = py3dmodel.fetch.shape2shapetype(py3dmodel.modify.uniform_scale(face, 
                                                                             cylinder_radius, 
                                                                             cylinder_radius, 
                                                                             cylinder_radius, 
                                                                             face_midpt))

face_scaled2 = py3dmodel.fetch.shape2shapetype(py3dmodel.modify.uniform_scale(face, 
...
scaled_cmpd = py3dmodel.fetch.shape2shapetype(py3dmodel.modify.uniform_scale(gcmpd, 
                                                                             0.03, 
                                                                             0.03, 
                                                                             0.03, 
                                                                             face_midpt))
grids = py3dmodel.fetch.geom_explorer(scaled_cmpd, "face")
meshed_hole = []
for grid in grids:
    ...
    face_scaled1 = py3dmodel.fetch.shape2shapetype(py3dmodel.modify.uniform_scale(face, 
                                                                             scale_factor, 
                                                                             scale_factor, 
                                                                             scale_factor, 
                                                                             face_midpt))
    
    moved_mesh = py3dmodel.fetch.shape2shapetype(py3dmodel.modify.move((0,0,0), (gmid_pt), face_scaled1))
...
text_face = py3dmodel.fetch.geom_explorer(brep_text, "face")
txt_list = []
for tf in text_face:
...
utility3d.write_2_collada(diff_shape3, "C:\\Users\\chenkianwee\\Desktop\\for_vicky\\vcylinder.dae")
display_2dlist = []
display_2dlist.append(diff_shape3)
#display_2dlist.append(txt_list)
py3dmodel.construct.visualise(display_2dlist, ["BLUE", "WHITE"])