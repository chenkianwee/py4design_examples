...
dae_file = "F:\\kianwee_work\\nus\\201804-201810\\hdb\\design\\model3d\\dae\\design.dae"
citygml_filepath = "F:\\kianwee_work\\nus\\201804-201810\\hdb\\design\\model3d\\gml\\design.gml"
...
is_shell_taller_than = analysisrulepalette.IsShellTallerThan(17)
#is_edge_in_boundary = analysisrulepalette.IsEdgeInBoundary()

id_resi_bldgs = templaterulepalette.IdentifyResidentialBuildingMassings()
id_resi_bldgs.add_analysis_rule(is_shell_closed, True)
id_resi_bldgs.add_analysis_rule(is_shell_in_boundary, True)
id_resi_bldgs.add_analysis_rule(shell_boundary_contains, False)
id_resi_bldgs.add_analysis_rule(is_shell_taller_than, True)
...
id_bldgs.add_analysis_rule(is_shell_taller_than, False)
...
massing_2_citygml.add_template_rule(id_resi_bldgs)
