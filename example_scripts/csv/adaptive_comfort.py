...
csv_path2 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_mrt_ct_ph25_mrt_avg_corrected_15mins.csv"
csv_path3 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_mrt_ct_ph26_mrt_avg_corrected_15mins.csv"
...
csv_path9 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_environment_ct_ph14_air_15mins.csv"
csv_path10 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_bestglobe_m2trdegc_15mins.csv"

csv_path11 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_panel2_surfacet_15mins.csv"
csv_path12 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_panel4_surfacet_15mins.csv"
csv_path13 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_panel6_surfacet_15mins.csv"
csv_path14 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_panel8_surfacet_15mins.csv"

csv_path15 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_environment_ct_ph23_dewpointt_15mins.csv"
csv_path16 = "F:\\kianwee_work\\princeton\\2019_01_to_2019_06\\coldtube\\data\\csv\\coldtube_data_15mins\\coldtube_predicted_mrt_15mins.csv"
...
t_list13, v_list13, tmax, tmin = csv2plot(csv_path13, index = [index_s, index_e])
t_list14, v_list14, tmax, tmin = csv2plot(csv_path14, index = [index_s, index_e])
t_list15, v_list15, tmax, tmin = csv2plot(csv_path15, index = [index_s, index_e])
t_list16, v_list16, tmax, tmin = csv2plot(csv_path16, index = [index_s, index_e])
...
ax1.set_xlabel('Time (Year-Month-Day)', fontsize=10)
...
ax1.legend(loc='upper center', bbox_to_anchor=(0.5, -0.3), fancybox=True, ncol=2)
#=================================================================================================================================
#THE SECOND AXIS
#=================================================================================================================================
#ax2 = ax1.twinx()
...
#==============================================
#for i in range(31): 
#    str_xmin = "2019-01-" + str(i+1) + "T08:00"
#    str_xmax = "2019-01-" + str(i+1) + "T20:00"
#    
#    xmin = parse(str_xmin )
#    xmax = parse(str_xmax)
