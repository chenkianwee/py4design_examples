...
import os
import ntpath
from py4design import py3dmodel, citygml2eval, massing2citygml, analysisrulepalette, templaterulepalette, gmlparmpalette,gmlparameterise,gml3dmodel, pyoptimise,utility
...
if taper == True:
    ...
    ntaper = len(utility.frange(taper_value_range[0],taper_value_range[1] + taper_value_range[2],taper_value_range[2]))
...
def eval_solar(citygml_filepath, weatherfilepath, dv_dir, ind_id):
    ...
    gml3dmodel.citygml2collada(citygml_filepath, dv_dae_filepath)
