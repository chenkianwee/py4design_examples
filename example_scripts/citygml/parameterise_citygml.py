...
citygml_filepath = os.path.join(parent_path, "example_files", "auto_parm_example","citygml", "punggol_luse101.gml")
result_citygml_filepath = os.path.join(parent_path, "example_files", "auto_parm_example","citygml", "punggol_variant5.gml" )
